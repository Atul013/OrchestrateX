...
Goal: Build a unified platform where multiple chatbots can coexist and an intelligent algorithm selects the best model for each query based on specialization. bleh bleh bleh
