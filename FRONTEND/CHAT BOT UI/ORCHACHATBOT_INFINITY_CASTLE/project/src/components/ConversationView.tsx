  ...
  <main className="flex-1 flex flex-col md:flex-row h-screen min-h-0">
      ...
      >
        <div className="p-4 md:p-6 border-b border-amber-600/30 flex-shrink-0 bg-gradient-to-r from-amber-900/20 via-orange-900/30 to-red-950/20 backdrop-blur-xl">
          <h2 className="text-amber-200 text-lg font-semibold">Conversation</h2>
          <div className="flex flex-wrap gap-2 mt-2">
            <span className="bg-gradient-to-r from-amber-500/20 to-yellow-500/20 text-amber-300 px-2 py-1 rounded-md text-xs border border-amber-600/30">
              Routed to: LLaMA 3 (0.82 confidence)
            </span>
            <span className="bg-gradient-to-r from-red-500/20 to-crimson-500/20 text-red-300 px-2 py-1 rounded-md text-xs border border-red-600/30">
        ...
        <section className="flex-1 flex flex-col min-h-0 h-0">
          <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar focus:scrollbar-thumb-amber-600 hover:scrollbar-thumb-amber-600" tabIndex={0} aria-label="Chat Messages">
            <ChatThread messages={currentChat.messages} onRefineMessage={onRefineMessage} />
          </div>
          <div className="flex-shrink-0 sticky bottom-0 bg-gradient-to-t from-amber-900/50 via-orange-900/30 to-transparent backdrop-blur-xl z-10">
